// STUB, and disposable. The real js/stickers.js (same exports, same fifteen entries) is being
// written in parallel by another session; this file exists only so the cover placement layer
// has something to import while that lands. At integration: change the one import in
// js/stickercover.js from "./stickers.stub.js" to "./stickers.js" and delete this file.
// Generated from scripts/stickers/STICKERS.md, which is the source of truth for the artwork.
