...
export const ACH_ICONS = {
  ...
  slipper: `<svg viewBox="0 0 24 24"><path d="M4.2 19.4 L5 15.4 C5.4 13.2 5 10.8 4.2 8.6 L6 9.2 C7 12 9 14.2 12.2 15.2 C15.4 16.2 18.6 16.6 20.8 18 C21.6 18.5 21.6 19.4 20.6 19.4 Z" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linejoin="round"/><path class="ink-fill" d="M4.2 19.4 L5 15.4 L6.4 15.7 L5.6 19.4 Z"/><path class="ink-fill" d="M15.4 5.4 L16.1 7 L17.7 7.7 L16.1 8.4 L15.4 10 L14.7 8.4 L13.1 7.7 L14.7 7 Z"/><circle class="ink-fill" cx="10.6" cy="4.4" r="0.7"/><circle class="ink-fill" cx="19" cy="10.4" r="0.6"/></svg>`,
