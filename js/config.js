...
export const ACHIEVEMENTS = [
  ...
  { id: "bejeweled",        name: "Bejeweled",        desc: "Hit a 5-in-a-row streak",             secret: false, icon: "strand" },
  ...
  { id: "you-knew-the-line", name: "You Knew The Line", desc: "Recall 5 lyric lines in one game",  secret: false, icon: "note" },
  ...
  { id: "eras-tour",        name: "The Eras Tour",    desc: "Score from nearly every studio album in one game", secret: false, icon: "ticket" },
  { id: "daylight",         name: "Daylight",         desc: "Score a perfect Daily",               secret: false, icon: "sunrise" },
  ...
  { id: "peace",            name: "Peace",            desc: "Finish a game without the timer hitting the red",  secret: false, icon: "dove" },
  { id: "perfect-storm",    name: "Perfect Storm",    desc: "Average under 3s per answer in a game", secret: false, icon: "storm" },
  ...
  { id: "holy-ground",      name: "Holy Ground",      desc: "Reach round 13 from scratch in Infinite", secret: false, icon: "rays" },
  ...
  { id: "word-for-word",    name: "Word For Word",    desc: "Recall a lyric line word-perfect",     secret: false, icon: "quote" },
  ...
  { id: "diamonds",         name: "Diamonds Are Forever", desc: "3 rare words right in a row (no Ultra)", secret: false, icon: "diamond" },
  { id: "wordsmith",        name: "Wordsmith",        desc: "Win a round on a fuzzy lyric match",    secret: false, icon: "anvil" },
  ...
  { id: "clearly-ready",    name: "…Clearly You Were Ready For It?", desc: "Recall 1,000 lyric lines word-perfect", secret: false, icon: "trophy" },
  { id: "overachiever",     name: "Overachiever",     desc: "Recall a whole verse (four lines word-perfect)", secret: false, icon: "aplus" },
  ...
  { id: "eyes-closed",      name: "Eyes Closed",      desc: "10 fuzzy lyric matches in one Lyricist game", secret: false, icon: "eyeclosed" },
