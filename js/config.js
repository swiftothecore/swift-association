...
export const ACH_ICONS = {
  ...
  // the page's ruled line running clean through the label: the word and the title are one thing
  wordlabel:`<svg viewBox="0 0 24 24"><path class="ink" stroke-width="0.95" opacity="0.5" d="M0.8 14.2 H23.2"/><circle class="ink-fill" cx="12" cy="12" r="9.2"/><circle class="ink" fill="none" stroke-width="0.8" opacity="0.45" cx="12" cy="12" r="7.8"/><circle class="ink" fill="none" stroke-width="1.15" cx="12" cy="12" r="5.7"/><path class="ink" stroke-width="1.3" fill="none" d="M8.4 12.9 C9.3 11.2 10.2 13.4 11.2 11.8 C12.2 10.2 13.1 12.6 14.2 11.3"/><circle cx="12" cy="14.2" r="0.6" fill="currentColor" stroke="none"/></svg>`,
  ...
  // the number circled in the margin, which is where thirteen has always been written here
  thirteen:`<svg viewBox="0 0 24 24"><ellipse class="ink" fill="none" stroke-width="1.35" cx="12" cy="12" rx="10.2" ry="9.4" transform="rotate(-6 12 12)"/><path class="ink" stroke-width="2" fill="none" d="M6.4 8.8 L8.8 6.6 V17.4"/><path class="ink" stroke-width="1.9" fill="none" d="M12.6 7.6 C15 6.1 17.6 7.2 17.2 9.4 C16.9 10.9 15.6 11.7 14.2 11.8 C16.2 11.7 17.8 12.7 17.7 14.6 C17.6 16.9 15 18.2 12.8 16.8"/></svg>`,
  // two records inside the same laurel, which is the whole feat: one year's winner answering another's
  laurel:`<svg viewBox="0 0 24 24"><g class="ink" stroke-width="1.25" fill="none"><path d="M8.6 21.2 C3.4 19 1.6 13.4 3.4 7.8"/><path d="M15.4 21.2 C20.6 19 22.4 13.4 20.6 7.8"/></g><g class="ink-fill"><ellipse cx="3.6" cy="11.4" rx="2" ry="0.85" transform="rotate(-62 3.6 11.4)"/><ellipse cx="5.4" cy="18.4" rx="2" ry="0.85" transform="rotate(-24 5.4 18.4)"/><ellipse cx="20.4" cy="11.4" rx="2" ry="0.85" transform="rotate(62 20.4 11.4)"/><ellipse cx="18.6" cy="18.4" rx="2" ry="0.85" transform="rotate(24 18.6 18.4)"/></g><circle class="ink-fill" cx="9.4" cy="11.8" r="3.9"/><circle cx="14.8" cy="14.6" r="3.9" fill="var(--paper)" stroke="currentColor" stroke-width="1.7"/><g fill="currentColor" stroke="none"><circle cx="9.4" cy="11.8" r="0.62"/><circle cx="14.8" cy="14.6" r="0.62"/></g></svg>`,
  ...
  sameagain:`<svg viewBox="0 0 24 24"><rect class="ink-fill" x="3" y="2.8" width="18" height="18.4" rx="1.5"/><g class="ink" stroke-width="0.85" opacity="0.3"><path d="M5.2 7.4 H18.8"/><path d="M5.2 11 H18.8"/><path d="M5.2 14.6 H18.8"/><path d="M5.2 18.2 H18.8"/></g><g class="ink" stroke-width="1.05" fill="none"><path d="M5.4 7.2 C6.3 6 7 7.6 7.9 6.5 C8.8 5.4 9.6 7 10.5 6.2"/><path d="M13 7.2 C13.9 6 14.6 7.6 15.5 6.5 C16.4 5.4 17.2 7 18.1 6.2"/><path d="M5.4 10.8 C6.3 9.6 7 11.2 7.9 10.1 C8.8 9 9.6 10.6 10.5 9.8"/><path d="M13 10.8 C13.9 9.6 14.6 11.2 15.5 10.1 C16.4 9 17.2 10.6 18.1 9.8"/><path d="M5.4 14.4 C6.3 13.2 7 14.8 7.9 13.7 C8.8 12.6 9.6 14.2 10.5 13.4"/><path d="M13 14.4 C13.9 13.2 14.6 14.8 15.5 13.7 C16.4 12.6 17.2 14.2 18.1 13.4"/><path d="M5.4 18 C6.3 16.8 7 18.4 7.9 17.3 C8.8 16.2 9.6 17.8 10.5 17"/><path d="M13 18 C13.9 16.8 14.6 18.4 15.5 17.3 C16.4 16.2 17.2 17.8 18.1 17"/></g></svg>`,
  ...
  shortlong:`<svg viewBox="0 0 24 24"><g class="ink" stroke-width="1.6" fill="none"><path d="M4.8 7.2 C6.1 4.6 7.7 8.4 9.1 6.2"/><path d="M4.8 15 C6.2 12.4 7.8 16.2 9.2 14 C10.6 11.8 12.2 15.6 13.6 13.4 C15 11.2 16.6 15 18 12.8 C18.6 11.9 19.2 12.7 19.6 13.2"/></g><g class="ink" stroke-width="1.15" opacity="0.75"><path d="M4 10.2 H9.6"/><path d="M4 9 V11.4"/><path d="M9.6 9 V11.4"/><path d="M4 18 H20"/><path d="M4 16.8 V19.2"/><path d="M20 16.8 V19.2"/></g></svg>`,
  ...
  wordchain:`<svg viewBox="0 0 24 24"><path class="ink" stroke-width="1.1" opacity="0.45" d="M2.6 6.2 H11.8"/><rect class="ink" fill="none" stroke-width="1.4" x="12.4" y="3.9" width="8.4" height="4.6" rx="1"/><path class="ink" stroke-width="1" opacity="0.8" fill="none" d="M13.8 6.5 C14.5 5.6 15.2 6.9 15.9 6 C16.6 5.1 17.3 6.4 18 5.7"/><rect class="ink" fill="none" stroke-width="1.4" x="3.2" y="15.5" width="8.4" height="4.6" rx="1"/><path class="ink" stroke-width="1" opacity="0.8" fill="none" d="M4.6 18.1 C5.3 17.2 6 18.5 6.7 17.6 C7.4 16.7 8.1 18 8.8 17.3"/><path class="ink" stroke-width="1.1" opacity="0.45" d="M12.2 17.8 H21.4"/><path class="ink" stroke-width="1.3" fill="none" d="M16.6 9.4 C17.8 12.2 12.6 12.4 9.4 14.3"/><g class="ink" stroke-width="1.2"><path d="M9.4 14.3 L12.2 14.4"/><path d="M9.4 14.3 L10.8 11.9"/></g></svg>`,
  // the cat asleep where the answer should have gone. The set already sits a cat up (`cat`);
  // this one is curled, so the two never read as the same animal at 30px
  catcurl:`<svg viewBox="0 0 24 24"><path class="ink-fill" d="M12.4 7.4 C17.6 7.4 21 10.4 21 14.2 C21 18 17.4 20.6 12.6 20.6 C8 20.6 4.2 18.2 4.2 14.4 C4.2 10.6 7.8 7.4 12.4 7.4 Z"/><path class="ink" stroke-width="1.5" fill="none" d="M20.6 17 C22.6 18.2 22.2 21.2 19.6 21.4 C18 21.5 16.8 20.8 16.4 19.6"/><g fill="var(--paper)" stroke="currentColor" stroke-width="1.6" stroke-linejoin="round"><path d="M5.6 13.2 L5.2 9 L8.8 11.2 Z"/><path d="M10 11.6 L12.4 8.6 L12.8 12.4 Z"/><circle cx="9" cy="15.4" r="4.4"/></g><g class="ink" stroke-width="1.05" fill="none"><path d="M6.8 15 C7.25 15.8 8 15.8 8.45 15"/><path d="M9.7 15 C10.15 15.8 10.9 15.8 11.35 15"/></g><path d="M8.2 17 H9.9 L9.05 18 Z" fill="currentColor" stroke="none"/></svg>`,
  ...
  stationsign:`<svg viewBox="0 0 24 24"><g class="ink" stroke-width="0.85" opacity="0.4"><path d="M1.6 5.4 H22.4"/><path d="M1.6 9.6 H22.4"/><path d="M1.6 13.8 H22.4"/><path d="M1.6 18 H22.4"/><path d="M6.2 5.4 V9.6"/><path d="M13.2 5.4 V9.6"/><path d="M20.2 5.4 V9.6"/><path d="M2.8 9.6 V13.8"/><path d="M9.8 9.6 V13.8"/><path d="M16.8 9.6 V13.8"/><path d="M6.2 13.8 V18"/><path d="M13.2 13.8 V18"/><path d="M20.2 13.8 V18"/><path d="M2.8 18 V21.6"/><path d="M9.8 18 V21.6"/><path d="M16.8 18 V21.6"/></g><rect x="3" y="7.2" width="18" height="6.6" rx="0.9" fill="var(--paper)" stroke="currentColor" stroke-width="1.7"/><path class="ink" stroke-width="1.3" fill="none" d="M5.4 11 C6.5 9.5 7.7 11.7 8.9 10.2 C10.1 8.7 11.3 10.9 12.5 9.6 C13.7 8.3 14.9 10.7 16 9.8 C16.9 9.1 17.8 10.2 18.6 10.1"/><path class="ink" stroke-width="1.05" opacity="0.55" fill="none" d="M4.6 19.4 C6.2 18 7.4 20.2 9 18.8 C10.6 17.4 11.8 19.6 13.4 18.4"/></svg>`,
...
export const ACHIEVEMENTS = [
  ...
  { id: "first-daily-finished", name: "Today Was A Fairytale", desc: "Finish your first Daily Challenge", secret: false, icon: "slipper", sitting: true, earn: { cat: "daily" } },
  ...
  { id: "answer-song-titled-the-prompt-word", name: "Well, Yes!", desc: "Answer with the song whose title is the prompt word", secret: false, icon: "wordlabel" },
  ...
  { id: "answer-thirteenth-track-on-page-13", name: "Right On Thirteen", desc: "Answer page 13 with an album's thirteenth track", secret: false, icon: "thirteen", sitting: true, earn: { cat: "difficulty" } },
  ...
  { id: "answer-karma-for-cat", name: "Karma Is A Cat", desc: "Answer “Karma” when the word is “cat”", secret: true, icon: "catcurl" },
