...
export function initDev(api) {
  ...
  body.append(section("custom / breadth",
    ...
    row("coffee raft",
        ...
        btn("pop one", () => api.mug.pop()),
        btn("clumps", () => { console.log("[dev] raft clumps", api.mug.clumps()); toast("raft clumps in console"); })),
    row("page marks",
  ...
  const doodleSel = select(["cat", "guitar", "scarf", "fence", "thirteen", "cardigan", "mirrorball", "paperplane", "willow", "seagulls"], (x) => x, (x) => x);
