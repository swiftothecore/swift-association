...
export const ACH_ICONS = {
  ...
  // a marked test paper with a big ringed zero, the A+ paper's opposite number. A hand mirror was
  // tried twice and read as a magnifying glass or a lollipop both times
  mirror:  `<svg viewBox="0 0 24 24"><g transform="rotate(-5 12 12)"><path class="ink-fill" d="M4.8 2.4 H15.8 L19.4 6 V21.6 H4.8 Z"/><path class="ink" stroke-width="1.1" d="M15.8 2.4 V6 H19.4"/><path class="ink" stroke-width="1" opacity="0.5" d="M7 5 H12.6"/><ellipse class="ink" stroke-width="2.1" cx="11.8" cy="12.8" rx="2.7" ry="3.7"/><path class="ink" stroke-width="1.15" d="M16.4 10.6 C16.8 14.2 14.8 17.6 11.6 17.7 C8.2 17.8 6.4 15 6.8 11.8 C7.2 8.8 9.4 7.4 11.8 7.5 C14 7.6 15.6 8.6 16.2 10"/><path class="ink" stroke-width="0.9" opacity="0.45" d="M7.2 19.8 H16.8"/></g></svg>`,
