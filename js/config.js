...
export const ACH_ICONS = {
  ...
  // a twig with three leaves in a row off one stem, and a bare shoot heading off the other way:
  // three from one album, time to branch out
  branch:  `<svg viewBox="0 0 24 24"><path class="ink" stroke-width="1.7" d="M3 21 C8 16.8 13 12.6 20.6 3.8"/><path class="ink" stroke-width="1.3" d="M13.6 11.2 C15.6 12 17.5 13.5 18.8 15.7"/><circle class="ink" stroke-width="1" stroke-dasharray="0.1 1.2" cx="19.4" cy="16.8" r="1"/><path class="ink-fill" d="M7.4 17 C5 16 4.6 13.8 5.6 12.5 C7.4 13.2 8.3 15 7.4 17 Z"/><path class="ink-fill" d="M11.3 13.3 C8.9 12.2 8.8 9.9 10 8.7 C11.8 9.6 12.4 11.4 11.3 13.3 Z"/><path class="ink-fill" d="M15.5 9.3 C13.5 7.9 13.5 5.7 14.9 4.7 C16.5 5.9 16.7 7.8 15.5 9.3 Z"/><g class="ink" stroke-width="0.8" opacity="0.5"><path d="M7.2 16.4 L5.9 13.2"/><path d="M11.1 12.7 L10.2 9.4"/><path d="M15.3 8.7 L15 5.4"/></g></svg>`,
  ...
  // If This Was A Movie, and the fans still arguing: a striped bucket of popcorn, a kernel or two
  // popping out. The clapperboard shrank to a briefcase
  clapper: `<svg viewBox="0 0 24 24"><path class="ink-fill" d="M5.2 10 H18.8 L17 21.6 H7 Z"/><g class="ink" stroke-width="1.1" opacity="0.6"><path d="M9.2 10.4 L9.8 21.2 M12 10.4 V21.2 M14.8 10.4 L14.2 21.2"/></g><path class="ink-fill" stroke-width="1.5" d="M5.2 10 C4 8.4 5 6.4 6.8 6.8 C7 4.8 9.4 4.2 10.4 5.6 C11 3.6 13.8 3.6 14.2 5.6 C15.4 4.4 17.6 5.2 17.2 7 C18.8 7 19.6 8.8 18.8 10"/><circle class="ink-fill" stroke-width="1.2" cx="20.6" cy="3.4" r="1.2"/><circle class="ink-fill" stroke-width="1.1" cx="3.2" cy="4.2" r="0.9"/><path class="ink" stroke-width="0.9" d="M21.8 5.6 L22.8 6.4 M1.8 2.2 L1 1.4"/></svg>`,
  // a sash window with the curtains drawn back and a pot on the sill: somebody's window, from outside
  window:  `<svg viewBox="0 0 24 24"><rect class="ink-fill" x="4.2" y="2.8" width="15.6" height="16.4"/><g class="ink" stroke-width="1.15"><path d="M12 2.8 V19.2"/><path d="M4.2 11 H19.8"/></g><path class="ink" stroke-width="1.8" d="M2.4 19.8 H21.6"/><path class="ink" stroke-width="1.2" d="M5 3.4 C7.4 5.8 7.6 8.6 6.4 10.8 C7.2 13.6 6.8 16.4 5.2 18.6"/><path class="ink" stroke-width="1.2" d="M19 3.4 C16.8 5.6 16.4 8.4 17.6 11.2 C16.9 14 17.2 16.6 18.8 18.6"/><g fill="currentColor"><circle cx="6.5" cy="11" r="0.7"/><circle cx="17.5" cy="11.2" r="0.7"/></g><path class="ink-fill" stroke-width="1.2" d="M14.4 17.2 H17 L16.6 19.4 H14.8 Z"/><path class="ink" stroke-width="1" d="M15.7 17.2 C15.6 16 15 15.4 14.4 15.2 M15.7 17.2 C15.9 16.2 16.5 15.6 17.2 15.6"/></svg>`,
  ...
  // a song both Aaron and Jack produced: headphones with an A on one cup and a J on the other.
  // Two overlapping circles were a Venn diagram
  overprint: `<svg viewBox="0 0 24 24"><path class="ink" stroke-width="1.8" d="M4.6 13.4 V11.6 C4.6 6.8 8 3.8 12 3.8 C16 3.8 19.4 6.8 19.4 11.6 V13.4"/><rect class="ink-fill" x="2.4" y="12.4" width="4.8" height="7.8" rx="2"/><rect class="ink-fill" x="16.8" y="12.2" width="4.8" height="8" rx="2"/><path class="ink" stroke-width="1.3" d="M3.6 18.6 L4.8 14.2 L6 18.6 M4.1 17 H5.5"/><path class="ink" stroke-width="1.3" d="M19.8 14 V17.6 C19.8 18.8 18.2 18.9 18 17.8"/></svg>`,
  ...
  // writing blind: the pen still going, its handwriting fading out behind it, solid at the nib,
  // then dashes, then dots. The word lifting off a bare ruled line read as a crack
  vanish:  `<svg viewBox="0 0 24 24"><path class="ink-fill" d="M13.8 13.8 L20 4.6 C20.6 3.8 21.8 4.6 21.2 5.4 L15.4 14.8 Z"/><path class="ink-fill" stroke-width="1.3" d="M13.8 13.8 L15.4 14.8 L13.4 17.2 Z"/><path class="ink" stroke-width="1.5" d="M13.2 17.4 C12.4 16 11.6 18.8 10.8 17.4 C10 16 9.2 18.8 8.4 17.4"/><path class="ink" stroke-width="1.4" opacity="0.7" stroke-dasharray="1.2 1.1" d="M7.6 17.4 C6.8 16 6 18.8 5.2 17.4"/><path class="ink" stroke-width="1.4" opacity="0.4" stroke-dasharray="0.1 1.7" d="M4.4 17.4 C3.6 16 2.8 18.8 2 17.4"/><path class="ink" stroke-width="0.9" opacity="0.4" d="M1.4 20.4 H22.6"/></svg>`,
  // one record, loyal to it all night: a picture disc cut into a heart, the grooves following the
  // shape. A round record with a heart on its label read as a target once the heart shrank away
  heartlabel: `<svg viewBox="0 0 24 24"><path class="ink-fill" d="M12 21 C12 21 2.6 15 2.6 8.8 C2.6 5.6 5 3.4 7.6 3.4 C9.6 3.4 11.2 4.6 12 6.2 C12.8 4.6 14.4 3.4 16.4 3.4 C19 3.4 21.4 5.6 21.4 8.8 C21.4 15 12 21 12 21 Z"/><path class="ink" stroke-width="1.3" opacity="0.4" transform="translate(12 11.2) scale(0.7) translate(-12 -11.2)" d="M12 21 C12 21 2.6 15 2.6 8.8 C2.6 5.6 5 3.4 7.6 3.4 C9.6 3.4 11.2 4.6 12 6.2 C12.8 4.6 14.4 3.4 16.4 3.4 C19 3.4 21.4 5.6 21.4 8.8 C21.4 15 12 21 12 21 Z"/><circle class="ink" stroke-width="1.1" cx="12" cy="10.8" r="2.5"/><circle cx="12" cy="10.8" r="0.75" fill="currentColor"/><path class="ink" stroke-width="1" opacity="0.6" d="M5.2 7.8 C5.6 6.4 6.6 5.5 7.8 5.3"/></svg>`,
  ...
  // staked the most you could hold, page after page: a stack of poker chips shoved over, one
  // flying off the top. The notched edges are what keep them chips; a heap of beads read as
  // grapes, or as the coins charm
  allin:   `<svg viewBox="0 0 24 24"><g class="ink" stroke-width="1.1" opacity="0.5"><path d="M1.2 11 H4 M0.8 14.2 H3.6 M1.4 17.4 H4.2"/></g><g transform="rotate(-8 12 14)"><ellipse class="ink-fill" cx="12" cy="8.2" rx="5.6" ry="1.9"/><path class="ink-fill" d="M6.4 8.2 V19.6 C6.4 22.2 17.6 22.2 17.6 19.6 V8.2"/><g class="ink" stroke-width="1.1"><path d="M6.4 11.2 C6.4 13.3 17.6 13.3 17.6 11.2"/><path d="M6.4 14.2 C6.4 16.3 17.6 16.3 17.6 14.2"/><path d="M6.4 17.2 C6.4 19.3 17.6 19.3 17.6 17.2"/></g><path class="ink" stroke-width="2.2" d="M9.2 10.4 V11.6 M14.8 10.4 V11.6 M12 13.9 V15.1 M8 16.2 V17.4 M16 16.2 V17.4 M10.4 19.9 V21 M14.2 19.9 V21"/></g><ellipse class="ink-fill" stroke-width="1.3" cx="19.4" cy="3.8" rx="2.4" ry="1.2" transform="rotate(26 19.4 3.8)"/></svg>`,
  ...
  // five dark sides beaten and not sorry: a little face with devil horns and its halo slipped
  // down onto one of them. The heart with a slipping halo read as a heart with a leaf on it
  halo: `<svg viewBox="0 0 24 24"><circle class="ink-fill" cx="12" cy="14.6" r="6.6"/><path class="ink-fill" stroke-width="1.4" d="M7.6 9.8 C6.2 8.2 6 6.2 6.6 4.6 C7.6 6.2 8.8 7.4 9.8 8.6 Z"/><path class="ink-fill" stroke-width="1.4" d="M16.6 10 C17.9 8.3 18.4 6.5 17.9 4.9 C16.9 6.5 15.6 7.7 14.4 8.6 Z"/><ellipse class="ink" stroke-width="1.4" cx="16.2" cy="4.2" rx="4.2" ry="1.4" transform="rotate(20 16.2 4.2)"/><path class="ink" stroke-width="1.3" d="M9 14.2 H10.6 M13.4 14.2 H15"/><path class="ink" stroke-width="1.2" d="M9.6 17.2 C11 18.4 13.2 18.4 14.6 17"/></svg>`,
  ...
  // the Anti-Hero campaign pin, VOTE FOR ME / FOR EVERYTHING cut down to the two words that
  // carry the joke: VOTE over the rule, ME knocked out of the inked lower half
  votepin: `<svg viewBox="0 0 24 24"><g transform="rotate(-6 12 12)"><path class="ink" stroke-width="1.2" d="M6.8 6.6 L7.9 9.8 L9 6.6 M11 6.5 C10 6.5 9.7 7.4 9.7 8.2 C9.7 9.1 10.1 9.9 10.9 9.9 C11.8 9.9 12.2 9.1 12.2 8.2 C12.2 7.3 11.8 6.5 11 6.5 Z M12.9 6.6 H15.2 M14.05 6.6 V9.9 M17.6 6.6 H16 V9.9 H17.6 M16 8.2 H17.2"/><path d="M2.7 13.1 H21.3 A9.35 9.35 0 0 1 2.7 13.1 Z" fill="currentColor" stroke="none"/><path class="ink" stroke-width="0.9" d="M2.9 11.6 H21.1"/><path stroke="var(--paper)" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.4" d="M8.7 18.2 V14.6 L10.2 16.6 L11.7 14.5 V18.2 M15.5 14.6 H13.1 V18.2 H15.5 M13.1 16.4 H14.9"/><path class="ink-fill" d="M12 2.5 C17.3 2.4 21.4 6.6 21.4 12.1 C21.4 17.5 17.2 21.6 12 21.5 C6.8 21.4 2.6 17.4 2.6 12 C2.6 6.6 6.8 2.6 12 2.5 Z"/></g></svg>`,
  // three guitar picks, each a different cut and marking: three game types, three ways to
  // hit the strings
  shapes:  `<svg viewBox="0 0 24 24"><g transform="translate(5.1 12.6) rotate(-10) scale(0.9)"><path class="ink-fill" d="M-3.6 -3.4 C-1.4 -4.6 1.4 -4.6 3.6 -3.4 C4.2 -3 4.2 -2 3.8 -1.2 L0.9 4.2 C0.5 4.9 -0.5 4.9 -0.9 4.2 L-3.8 -1.2 C-4.2 -2 -4.2 -3 -3.6 -3.4 Z"/><circle cx="0" cy="-1.3" r="0.85" fill="currentColor"/></g><g transform="translate(12 10.6) rotate(3)"><path class="ink-fill" d="M-3.4 -3.6 C-1.2 -4.8 1.6 -4.6 3.8 -3.2 C4.3 -2.8 4.2 -1.8 3.8 -1.1 L0.8 4.4 C0.4 5.1 -0.6 5.1 -1 4.4 L-3.8 -1.4 C-4.2 -2.2 -4 -3.2 -3.4 -3.6 Z"/><path class="ink" stroke-width="1" d="M0 -3 L0.7 -1.5 L2.2 -1.3 L1.1 -0.3 L1.4 1.2 L0 0.5 L-1.4 1.2 L-1.1 -0.3 L-2.2 -1.3 L-0.7 -1.5 Z"/></g><g transform="translate(18.9 12.9) rotate(12) scale(0.86)"><path class="ink-fill" d="M-3.6 -3.4 C-1.4 -4.6 1.4 -4.6 3.6 -3.4 C4.2 -3 4.2 -2 3.8 -1.2 L0.9 4.2 C0.5 4.9 -0.5 4.9 -0.9 4.2 L-3.8 -1.2 C-4.2 -2 -4.2 -3 -3.6 -3.4 Z"/><path class="ink" stroke-width="1.1" d="M-2.2 -2.4 H2.2 M-1.6 -0.6 H1.6"/></g><path class="ink" stroke-width="0.9" opacity="0.4" d="M2 20.4 H22"/></svg>`,
  // a school locker door, vents, lift handle and a heart doodled on it in marker: freshman year
  locker:  `<svg viewBox="0 0 24 24"><rect class="ink-fill" x="5.4" y="2" width="13.2" height="20" rx="1"/><g class="ink" stroke-width="1.1"><path d="M8 4.6 H16"/><path d="M8.1 6.2 H15.9"/><path d="M8 7.8 H16"/></g><path class="ink" stroke-width="2.2" d="M15.8 11.6 V15.2"/><path class="ink" stroke-width="1.2" d="M10.2 12.9 C9.4 12 8.1 12.4 8.3 13.6 C8.5 14.7 10.2 15.8 10.2 15.8 C10.2 15.8 12 14.6 12.1 13.5 C12.2 12.3 10.9 12 10.2 12.9 Z"/><path class="ink" stroke-width="0.9" opacity="0.4" d="M5.4 19.4 H18.6"/></svg>`,
  ...
  // a daisy pushing up through a crack in the pavement: an Ultra game, survived
  poppy:   `<svg viewBox="0 0 24 24"><path class="ink" stroke-width="1.7" d="M1.8 17.8 H22.2"/><path class="ink" stroke-width="0.9" opacity="0.45" d="M1.8 21.4 H22.2 M6.6 17.8 V21.4 M18 17.8 V21.4"/><path class="ink" stroke-width="1.2" d="M11.2 17.8 L12.7 19.3 L11.7 21.4"/><path class="ink" stroke-width="1.4" d="M12 17.8 C12.1 14.6 11.6 12.2 12 9.4"/><path class="ink-fill" stroke-width="1.3" d="M12 14.6 C13.8 13.1 15.6 13.3 16.4 14.6 C14.8 15.7 13.2 15.6 12 14.6 Z"/><g class="ink" stroke-width="1.15"><ellipse cx="12" cy="3.3" rx="1.25" ry="2" transform="rotate(4 12 6.4)"/><ellipse cx="12" cy="3.4" rx="1.3" ry="2" transform="rotate(63 12 6.4)"/><ellipse cx="12" cy="3.5" rx="1.2" ry="1.9" transform="rotate(118 12 6.4)"/><ellipse cx="12" cy="3.3" rx="1.3" ry="2.05" transform="rotate(183 12 6.4)"/><ellipse cx="12" cy="3.4" rx="1.25" ry="1.95" transform="rotate(239 12 6.4)"/><ellipse cx="12" cy="3.5" rx="1.2" ry="1.9" transform="rotate(298 12 6.4)"/></g><circle cx="12" cy="6.4" r="1.55" fill="currentColor"/></svg>`,
  // a mountain strapped to a hand trolley, speed lines behind it: mountains, moved
  coronet: `<svg viewBox="0 0 24 24"><path class="ink-fill" d="M3.8 16.8 L9.3 6.1 L12 10.3 L14.1 7.7 L18.9 16.8 Z"/><path class="ink" stroke-width="0.95" opacity="0.55" d="M7.7 9.2 L8.9 8.5 L10.2 9.4 L11.1 8.7"/><path class="ink" stroke-width="1.9" d="M3.2 17.4 H19.6"/><path class="ink" stroke-width="1.6" d="M19.6 17.4 L21.6 11.2 L22.6 11.5"/><g class="ink-fill" stroke-width="1.4"><circle cx="6.2" cy="19.9" r="1.55"/><circle cx="16.3" cy="19.9" r="1.55"/></g><g class="ink" stroke-width="1" opacity="0.55"><path d="M0.8 10.8 H2.6"/><path d="M0.5 13.4 H2.3"/><path d="M1.1 8.4 H2.9"/></g></svg>`,
  ...
  // midnight: a twin-bell alarm clock on its feet with both hands on twelve. A bare dial with the
  // hands straight up read as one stroke in a ring
  clock:   `<svg viewBox="0 0 24 24"><path class="ink-fill" stroke-width="1.4" d="M3.6 8.4 A3.2 3.2 0 0 1 8 3.8 Z"/><path class="ink-fill" stroke-width="1.4" d="M16 3.8 A3.2 3.2 0 0 1 20.4 8.2 Z"/><path class="ink" stroke-width="1.2" d="M12 6.2 V4.4 M10.8 4.2 H13.2"/><circle class="ink-fill" cx="12" cy="13.2" r="7"/><path class="ink" stroke-width="1.5" d="M7.4 18.8 L5.8 21.2 M16.6 18.8 L18.2 21.2"/><g class="ink" stroke-width="1" opacity="0.6"><path d="M17.3 13.2 H16.5 M12 18.4 V17.6 M6.7 13.2 H7.5"/></g><path class="ink" stroke-width="1.8" d="M12 13.4 V7.9"/><path class="ink" stroke-width="2.2" d="M12 13.4 V10.2"/><circle cx="12" cy="13.4" r="0.9" fill="currentColor"/></svg>`,
  // a ball bouncing back higher every time, three bounces: players gonna play, you kept going
  bounce:  `<svg viewBox="0 0 24 24"><path class="ink" stroke-width="1.6" d="M1.6 20.8 H22.4"/><path class="ink" stroke-width="1.4" stroke-dasharray="0.1 1.7" d="M2.2 12.6 C3.8 14 5.2 17 6 20.3 C7 16.6 9 16.6 10 20.3 C11.4 13.4 13.6 13.4 15 20.3 C15.6 16.4 16.5 12.8 17.5 10.8"/><circle class="ink-fill" cx="19" cy="8" r="2.9"/><path class="ink" stroke-width="0.95" d="M16.6 7 C18 7.6 19.8 7.4 21.3 6.5"/><g class="ink" stroke-width="1" opacity="0.55"><path d="M5.2 21.9 L4.6 22.8 M6.8 21.9 L7.4 22.8"/><path d="M9.2 21.9 L8.6 22.8 M10.8 21.9 L11.4 22.8"/><path d="M14.2 21.9 L13.6 22.8 M15.8 21.9 L16.4 22.8"/></g></svg>`,
  // a dove in flight, wing up, an olive sprig in its beak: the timer never saw red
  dove:    `<svg viewBox="0 0 24 24"><path class="ink-fill" d="M3.6 9.8 L5 9.2 C5.4 7.6 6.8 6.9 8.2 7.4 C9.4 7.9 10 9 10.2 10.2 C12.8 11 15.6 10.8 18.2 9.6 L21.6 8.3 L20 11 L21.8 12.7 L18.6 12.9 C16.6 15.1 13.2 16.2 10 15.4 C7.6 14.8 6.1 13.2 5.6 11 L5 10.3 Z"/><path class="ink-fill" d="M10.6 11.2 C11.2 7.4 13.6 4.4 17.6 3 C17.1 6.1 15.8 8.8 13.8 11"/><path class="ink" stroke-width="0.9" opacity="0.55" d="M12.6 9.4 L15.3 6.1 M13.5 10.4 L16.2 8"/><circle cx="7.5" cy="9.1" r="0.6" fill="currentColor"/><path class="ink" stroke-width="1.05" d="M3.7 10.2 C3 12 2.9 14 3.5 16"/><ellipse class="ink-fill" stroke-width="1.1" cx="2.5" cy="12.6" rx="1.15" ry="0.55" transform="rotate(-62 2.5 12.6)"/><ellipse class="ink-fill" stroke-width="1.1" cx="4.5" cy="14.4" rx="1.1" ry="0.5" transform="rotate(-24 4.5 14.4)"/></svg>`,
  // a head with the blindfold tied round it, knot and tails off the side: never answered once.
  // The band on its own read as a ribbon or a bandage
  blindfold:`<svg viewBox="0 0 24 24"><circle class="ink-fill" cx="11.6" cy="12" r="8.6"/><path d="M2.8 9.5 C7.6 7.9 15.6 7.9 20.4 9.4 L20.2 14.2 C15.6 12.8 7.8 12.8 3.1 14.3 Z" fill="var(--paper)" stroke="currentColor" stroke-width="1.7" stroke-linejoin="round"/><path class="ink" stroke-width="0.9" opacity="0.45" d="M5 11.2 C9 10.2 14.4 10.2 18.4 11"/><circle class="ink-fill" stroke-width="1.4" cx="20.9" cy="11.8" r="1.4"/><path class="ink" stroke-width="1.4" d="M21.7 13 C22.5 15.5 22 17.8 20.7 19.6"/><path class="ink" stroke-width="1.3" d="M20.3 13.2 C20.1 15.6 19.2 17.1 17.9 18.1"/><path class="ink" stroke-width="1.1" d="M9.6 17.2 C10.8 17.9 12.4 17.9 13.6 17.2"/></svg>`,
  ...
  // read as a teapot or a pram, and its wheels vanished small
  coach:   `<svg viewBox="0 0 24 24"><path class="ink-fill" d="M2.8 15.6 C2.8 13.6 5 12.8 7.4 13.2 C10 13.6 12.4 13 14.4 10.6 L16.8 7.4 C17.4 6.6 18.6 6.4 19.4 7 L20.8 8.2 C21.4 8.8 21.4 9.8 20.8 10.4 L19.6 11.6 L20.6 20 H19.2 L17.4 13.6 C15.6 15.4 13.2 17 9.8 17.6 L4.6 17.8 C3.6 17.8 2.8 16.8 2.8 15.6 Z"/><path class="ink" stroke-width="1" opacity="0.6" d="M5.2 15.6 C7 16 9 15.8 10.6 15.2"/><path class="ink" stroke-width="0.9" opacity="0.5" d="M16.6 9.2 L18.4 10.6"/><path class="ink" stroke-width="1.2" d="M7.6 3.2 V8.2 M5.1 5.7 H10.1"/><path class="ink" stroke-width="1" d="M13 1.8 V4 M11.9 2.9 H14.1"/></svg>`,
  ...
  // a strand that drops to the miss (the cross) and climbs back up five beads to an arrow: the
  // comeback streak in the bracelet's own language
  scribbleline:`<svg viewBox="0 0 24 24"><path class="ink" stroke-width="0.9" opacity="0.4" d="M1.8 21 H22.2"/><path class="ink" stroke-width="1.3" d="M2.4 7.6 L5.8 16.4 L8.4 14.4 L10.8 12.8 L13.3 10.6 L15.7 8.8 L18.3 6 L20.6 3.6"/><path class="ink" stroke-width="1.4" d="M18.2 3.1 L20.8 3.4 L20.6 6"/><path class="ink" stroke-width="1.2" d="M4.8 18.2 L6.8 20.2 M6.8 18.2 L4.8 20.2"/><g class="ink-fill" stroke-width="1.3"><circle cx="8.4" cy="14.4" r="1.15"/><circle cx="10.8" cy="12.8" r="1.2"/><circle cx="13.3" cy="10.6" r="1.1"/><circle cx="15.7" cy="8.8" r="1.2"/><circle cx="18.3" cy="6" r="1.15"/></g></svg>`,
  // an ice lolly with a bite out of it and three drips going, one for each life lost to july
  lolly:   `<svg viewBox="0 0 24 24"><path class="ink-fill" d="M7.6 5.6 C7.6 3.3 9.4 2 12 2 C13.4 2 14.5 2.4 15.3 3.1 C14.3 3.6 14 4.7 14.6 5.4 C15.2 6 16 6.1 16.4 5.6 V14.6 C16.4 15.4 15.8 16 15 16 H9 C8.2 16 7.6 15.4 7.6 14.6 Z"/><path class="ink" stroke-width="0.9" opacity="0.45" d="M9.2 9.4 L14.8 7.2 M9.2 12.4 L14.8 10.2"/><rect class="ink-fill" stroke-width="1.4" x="10.8" y="16" width="2.4" height="5.9" rx="1.1"/><path d="M9.6 16 V17.3 C9.6 18.1 10.6 18.1 10.6 17.3 V16 Z" fill="currentColor"/><path d="M5.3 17.4 C6.1 18.4 6.2 19.3 5.3 19.3 C4.4 19.3 4.5 18.4 5.3 17.4 Z" fill="currentColor"/><path d="M17.8 19.2 C18.6 20.2 18.7 21.1 17.8 21.1 C16.9 21.1 17 20.2 17.8 19.2 Z" fill="currentColor"/></svg>`,
  ...
  // a ball of yarn with its loose end trailing off: a hundred lines wound up, and you don't
  // even know where it starts
  spiral:  `<svg viewBox="0 0 24 24"><circle class="ink-fill" cx="11" cy="11" r="7.3"/><g class="ink" stroke-width="1.05"><path d="M5.4 7.7 C8.6 8.8 12.6 12.9 14 18"/><path d="M7.8 4.6 C11.6 6.2 16 10.4 17.8 15.2"/><path d="M4.1 12.4 C6.8 13 9.4 15.4 10.4 18.2"/><path d="M13.8 4.1 C11 7.4 8.8 12.4 8.6 17.9"/></g><path class="ink" stroke-width="1.4" d="M17.9 14.3 C20.4 15.5 21 18 19.6 19.4 C18.6 20.4 19.4 21.7 21.9 21.2"/></svg>`,
  ...
  // one note inside a looping arrow: someone has a favourite song
  repeat:  `<svg viewBox="0 0 24 24"><path class="ink" stroke-width="1.7" d="M15.8 4.2 C19.2 5.6 21 9 20.4 12.8 C19.6 17.6 15.4 20.8 11 20.4 C6.4 20 3.2 16 3.4 11.4 C3.6 7.4 6.4 4.2 10.2 3.4"/><path class="ink" stroke-width="1.6" d="M8 1.6 L10.4 3.4 L8.2 5.4"/><ellipse cx="10.4" cy="15.2" rx="1.9" ry="1.4" transform="rotate(-20 10.4 15.2)" fill="currentColor"/><path class="ink" stroke-width="1.4" d="M12.1 14.6 V7.6 C14 8.4 15.3 9.4 14.8 11.5"/></svg>`,
  ...
  // a diamond ring, stone faceted, catching the light: shiny, literally. Two linked rings drawn
  // heavy enough to read came out as two black discs
  rings:   `<svg viewBox="0 0 24 24"><circle class="ink-fill" cx="12" cy="15.6" r="5.7"/><circle class="ink" stroke-width="0.9" opacity="0.4" cx="12" cy="15.6" r="4.3"/><path class="ink-fill" stroke-width="1.3" d="M10.1 10.3 L10.8 9.1 H13.3 L13.9 10.3"/><path class="ink-fill" d="M8.4 6.3 L10.3 3.6 H13.8 L15.7 6.4 L12 9.4 Z"/><path class="ink" stroke-width="0.95" d="M8.5 6.3 H15.6 M10.3 3.7 L12 6.3 L13.8 3.7 M12 6.3 V9.2"/><path class="ink" stroke-width="1.2" d="M19.2 2.2 V5.6 M17.5 3.9 H20.9"/><path class="ink" stroke-width="1" d="M4.4 6.8 V8.6 M3.5 7.7 H5.3"/></svg>`,
  // every draft it took: a wire wastepaper bin with one crumpled page in its rim, one missed on
  // the floor and one in the air. A crumpled ball on its own read as a basketball
  crumple: `<svg viewBox="0 0 24 24"><path class="ink-fill" d="M3.4 9.8 L4.8 20.4 C5 21.4 14.6 21.4 14.8 20.4 L16.2 9.8"/><ellipse class="ink" stroke-width="1.5" cx="9.8" cy="9.8" rx="6.4" ry="1.8"/><g class="ink" stroke-width="0.8" opacity="0.45"><path d="M5.6 12.6 L12.6 20.8 M9 12 L14.6 18.4 M4.4 15 L9 20.9 M14 12.6 L7 20.8 M10.6 12 L5 18.4 M15.2 15 L10.6 20.9"/></g><path class="ink-fill" stroke-width="1.3" d="M7.2 9.4 L7.8 7 L10.2 6.2 L12.2 7.6 L12.2 9.6"/><path class="ink" stroke-width="0.8" opacity="0.6" d="M8.6 8.4 L10.2 8.8 L10.8 7.2"/><path class="ink-fill" stroke-width="1.4" d="M16.8 19.4 L17.6 17.2 L19.8 16.6 L21.6 18 L21.2 20.6 L18.8 21.4 L17.2 20.8 Z"/><path class="ink" stroke-width="0.8" opacity="0.6" d="M18 18.4 L19.6 19.2 L20.2 17.4 M19.6 19.2 L19.2 21"/><path class="ink-fill" stroke-width="1.3" d="M18.4 3.6 L19.2 2.2 L20.8 2.2 L21.6 3.6 L21 5.2 L19.2 5.2 Z"/><path class="ink" stroke-width="0.9" stroke-dasharray="0.1 1.6" d="M18.2 6.4 C17 7.4 16.2 8.2 15.6 9"/></svg>`,
  ...
  // every answer before the door turned: a pawn with its opening double step marked out ahead
  // of it, the one move that goes two squares and only on the first go. The revolving door
  // seen from above read as a crosshair
  twosteps:`<svg viewBox="0 0 24 24"><g class="ink" stroke-width="0.9" opacity="0.4"><rect x="7.6" y="1.8" width="8.8" height="4.6"/><rect x="7.6" y="6.4" width="8.8" height="4.6"/></g><path class="ink" stroke-width="1.3" stroke-dasharray="1.4 1.3" d="M12 10.2 V4.4"/><path class="ink" stroke-width="1.4" d="M10 5.4 L12 3.2 L14 5.4"/><circle class="ink-fill" cx="12" cy="13.4" r="2.4"/><path class="ink" stroke-width="1.4" d="M9.6 16.2 H14.4"/><path class="ink-fill" d="M10.4 16.2 C10.4 18 9.6 19.2 8.2 19.9 H15.8 C14.4 19.2 13.6 18 13.6 16.2"/><rect class="ink-fill" x="6.8" y="19.9" width="10.4" height="2" rx="0.8"/></svg>`,
  ...
  // Manhattan cut to three buildings you can name, the Empire State, a Chrysler crown and a
  // squat block, with one seagull: welcome to New York
  skyline: `<svg viewBox="0 0 24 24"><path class="ink" stroke-width="1.7" d="M1.8 20.8 H22.2"/><path class="ink-fill" d="M3.8 20.8 V13 H8.4 V20.8"/><path class="ink-fill" d="M10 20.8 V11 H10.8 V8.6 H11.4 V6 H12.6 V8.6 H13.2 V11 H14 V20.8"/><path class="ink" stroke-width="1.2" d="M12 6 V2.2"/><path class="ink-fill" d="M15.6 20.8 V10 L17.7 7.2 L19.8 10 V20.8"/><path class="ink" stroke-width="1" d="M17.7 7.2 V5.2"/><g fill="currentColor"><rect x="5" y="14.6" width="0.9" height="1.2"/><rect x="6.6" y="14.6" width="0.9" height="1.2"/><rect x="5" y="17.2" width="0.9" height="1.2"/><rect x="11.5" y="13" width="1" height="1.3"/><rect x="11.5" y="16" width="1" height="1.3"/><rect x="17.2" y="12.2" width="1" height="1.2"/></g><path class="ink" stroke-width="1.05" d="M16.4 3.6 C17.1 2.8 17.8 2.8 18.4 3.6 C19 2.8 19.8 2.8 20.6 3.5"/></svg>`,
  ...
  // the bracelet itself, letter beads on a cord laid down in a slack arc with the tied ends
  // hanging. The beads are paper-filled so the cord runs behind them. A bare symmetric arc
  // reads as a mouth at charm size; the three big letter cubes are what stop it
  keepsake:`<svg viewBox="0 0 24 24"><path class="ink" stroke-width="1.15" d="M2.6 8.8 C5 14.6 8.6 16.4 12 16.4 C15.4 16.4 19 14.6 21.4 8.8"/><circle class="ink-fill" stroke-width="1.2" cx="2.6" cy="8.6" r="0.7"/><path class="ink" stroke-width="1.1" d="M2.2 9.2 L1.2 12.2 M2.9 9.3 L2.5 12.6"/><circle class="ink-fill" stroke-width="1.2" cx="21.4" cy="8.6" r="0.7"/><path class="ink" stroke-width="1.1" d="M21.1 9.3 L21.6 12.4 M21.8 9.2 L22.9 11.8"/><circle fill="var(--paper)" stroke="currentColor" stroke-linejoin="round" stroke-width="1.4" cx="4.9" cy="12.8" r="1.35"/><circle fill="var(--paper)" stroke="currentColor" stroke-linejoin="round" stroke-width="1.4" cx="19.1" cy="12.9" r="1.3"/><g fill="var(--paper)" stroke="currentColor" stroke-linejoin="round" stroke-width="1.5"><rect x="6.3" y="12.9" width="3.8" height="3.8" rx="0.6" transform="rotate(27 8.2 14.8)"/><rect x="10.1" y="14.4" width="3.8" height="3.8" rx="0.6" transform="rotate(-2 12 16.3)"/><rect x="13.9" y="12.9" width="3.8" height="3.8" rx="0.6" transform="rotate(-26 15.8 14.8)"/></g><g class="ink" stroke-width="1.05"><path d="M7.3 13.9 L9.5 15 M8.4 14.4 L7.8 16"/><path d="M11.2 15.4 C11.8 14.9 12.9 15.2 12.4 16.1 C12 16.8 12.8 17.3 13.4 16.8"/><path d="M15 14.9 C14.9 14 16 13.8 16.1 14.6 C16.5 14 17.3 14.6 16.9 15.3 L15.9 16.4 Z"/></g></svg>`,
  ...
  /* ---- Bonus games shelf ----
     ...
     Two deliberate pairs sit in here, and they are pairs on purpose:
  ...
  // the whole shelf swept, so the disc goes on the wall: framed, hung on its nail by a wire, a
  // glint off it. The wire and the tilt are load-bearing; without them it was a washing machine
  goldrecord:`<svg viewBox="0 0 24 24"><circle cx="12" cy="1.8" r="0.8" fill="currentColor"/><path class="ink" stroke-width="1" d="M5.6 6.4 L12 1.8 L18.4 6"/><g transform="rotate(-4 12 14)"><rect class="ink-fill" x="3.4" y="6" width="17.2" height="16" rx="0.8"/><rect class="ink" stroke-width="0.9" opacity="0.5" x="5.2" y="7.8" width="13.6" height="12.4"/><circle class="ink" stroke-width="1.4" cx="12" cy="13" r="4.4"/><circle class="ink" stroke-width="0.8" opacity="0.45" cx="12" cy="13" r="3"/><circle cx="12" cy="13" r="1.2" fill="currentColor"/><path class="ink" stroke-width="1.5" d="M10.2 18.9 H13.8"/></g><path class="ink" stroke-width="1.1" d="M21.2 2.4 V4.8 M20 3.6 H22.4"/></svg>`,
  ...
  // every strip bought and the song still named: a price tag on its string, a peeled strip
  // curled up beside it. You knew the price. A heap of loose strips read as a hat or a stapler
  peeled: `<svg viewBox="0 0 24 24"><g transform="rotate(-18 12 12.6)"><path class="ink-fill" d="M7.4 6.6 H19 V19.4 H7.4 L3.8 13 Z"/><circle class="ink" stroke-width="1.1" cx="7" cy="13" r="1"/><path class="ink" stroke-width="1" d="M6.2 12.4 C3.8 11.2 2.4 9.2 3.4 6.8"/><path class="ink" stroke-width="1.7" d="M10.6 10.8 H16.2 M10.6 14.6 H14.2"/></g><path class="ink-fill" stroke-width="1.2" d="M13.6 21.8 C16.2 22.4 19.4 21.8 20.6 20.4 C21.6 19.2 20.4 17.8 19.4 18.8 C18.6 19.6 19.4 20.2 20 19.8 L20.2 20.8 C18.8 21.4 16 21.4 13.8 20.8 Z"/></svg>`,
  ...
  // a snail, eyes on stalks, trail behind: every answer over ten seconds
  dwell:`<svg viewBox="0 0 24 24"><path class="ink-fill" d="M2.2 18.8 C2.4 16 3.9 14.4 5.7 14.6 C6.9 14.8 7.4 16 8 17.2 H19.4 C20.8 17.2 21.8 18 21.6 19.2 L3.2 19.6 C2.6 19.6 2.2 19.3 2.2 18.8 Z"/><circle class="ink-fill" cx="13.4" cy="11.4" r="5.7"/><path class="ink" stroke-width="1.15" d="M13.4 11.4 C13.4 10.4 14.8 10.4 14.8 11.6 C14.8 13.2 12.6 13.4 12 11.8 C11.2 9.8 13.2 8.2 15 8.8 C17.4 9.6 17.6 12.8 16 14.4"/><g class="ink" stroke-width="1.1"><path d="M4.6 14.8 L3.3 10.8"/><path d="M6 14.7 L6.8 10.5"/></g><g fill="currentColor"><circle cx="3.2" cy="10.3" r="0.7"/><circle cx="6.9" cy="10" r="0.7"/></g><path class="ink" stroke-width="1" opacity="0.45" stroke-dasharray="1.6 1.3" d="M9 21.4 H22.4"/></svg>`,
  ...
  // poison ivy's leaves of three on one stalk: leaves of three, let it be, which you didn't,
  // five times
  ivyword:`<svg viewBox="0 0 24 24"><path class="ink" stroke-width="1.6" d="M12 21.6 C12.1 18.6 11.7 16 12 13.3"/><path class="ink-fill" d="M12 13.3 C9 11.6 8.4 7 12 2.6 C13.2 4.2 13.4 4.8 14.2 5.1 C13.8 5.8 14.6 6.8 14.9 7.6 C15.2 10.6 14.4 12.2 12 13.3 Z"/><path class="ink-fill" d="M11.6 13.6 C8.4 15.4 4 14.7 2.5 11.4 C3.6 10.8 4.2 10.3 4.6 10.8 C5.4 10.1 6.4 10 7.2 10.2 C9.4 10.8 10.8 11.8 11.6 13.6 Z"/><path class="ink-fill" d="M12.4 13.4 C14.4 10.5 18.8 9.6 21.6 11.8 C21 12.6 20.6 13.3 20 13.2 C19.8 14.2 19 14.6 18.2 14.9 C16 15.6 14 15 12.4 13.4 Z"/><g class="ink" stroke-width="0.85" opacity="0.5"><path d="M12 12.6 V4.6"/><path d="M11 13.4 L4 11.6"/><path d="M13 13.2 L20.2 11.9"/></g></svg>`,
  ...
  // seven days in a row, running like water: a dripping tap with the drops still falling. The
  // ticked-off week hung up read as a keyboard
  sevendays:`<svg viewBox="0 0 24 24"><rect class="ink-fill" stroke-width="1.3" x="1.4" y="6.2" width="1.8" height="6.2" rx="0.4"/><path class="ink-fill" d="M3.2 7.6 H13.6 C16.4 7.6 18 9.2 18 12 V13.4 H14.8 V12.2 C14.8 11.4 14.2 10.8 13.4 10.8 H3.2 Z"/><path class="ink" stroke-width="1.5" d="M8.4 7.6 V4.6 M5.6 4.2 H11.2"/><g fill="currentColor"><path d="M16.4 15 C17.2 16 17.3 16.8 16.4 16.8 C15.5 16.8 15.6 16 16.4 15 Z"/><path d="M16.4 18 C17.1 18.8 17.2 19.5 16.4 19.5 C15.6 19.5 15.7 18.8 16.4 18 Z"/><path d="M16.4 20.8 C16.9 21.4 17 22 16.4 22 C15.8 22 15.9 21.4 16.4 20.8 Z"/></g></svg>`,
  ...
  // all twelve months: one tree split down the trunk, in leaf on one side and bare with snow on
  // the other, a leaf falling between. The year drawn as a dial of twelve beads read as a gear
  twelvemonths:`<svg viewBox="0 0 24 24"><path class="ink" stroke-width="1" opacity="0.45" d="M3.6 22 H20.4"/><path class="ink" stroke-width="1.8" d="M12 22 V12.4"/><path class="ink-fill" d="M12 4 C8.6 3.4 5 5.6 4.6 9 C4.2 12.4 6.6 15 9.2 15.2 C10.4 15.3 11.4 14.8 12 14.2 Z"/><g class="ink" stroke-width="0.9" opacity="0.5"><path d="M6.8 8.6 C7.5 7.8 8.4 7.6 9 7.8 M6.8 11.6 C7.6 10.8 8.6 10.8 9.2 11 M9.4 5.8 C10 5.2 10.7 5.2 11.1 5.4"/></g><path class="ink" stroke-width="1.3" d="M12 12.6 L16.6 7.4 M14.6 9.6 L18.8 9.8 M12 9.6 L13.8 5 M15.8 8.3 L16.4 4.8 M13.4 11.2 L19 12.8"/><path class="ink" stroke-width="1" d="M19.8 2.6 V6.4 M18.2 3.6 L21.4 5.4 M18.2 5.4 L21.4 3.6"/><ellipse class="ink-fill" stroke-width="1.1" cx="17.6" cy="17.6" rx="1.5" ry="0.7" transform="rotate(-32 17.6 17.6)"/></svg>`,
  ...
  // thirteen taps on the one drawing you are allowed to touch: the scarf hung on a peg, fringe at
  // both ends, the taps coming off it. Held loose in the air it was a muddle beside `scarf`
  scarftap:`<svg viewBox="0 0 24 24"><path class="ink" stroke-width="1.3" d="M1.8 4.4 H22.2"/><path class="ink-fill" d="M11 5.6 C9.4 9 8.6 13.6 8.4 18.8 L11.2 18.8 C11.3 14 11.8 9.8 12.8 6.6 Z"/><path class="ink-fill" d="M12.6 6.2 C13.8 9 14.4 12.4 14.6 16.2 L17.2 15.8 C16.8 11.6 15.6 8 13.4 5.4 Z"/><circle class="ink-fill" stroke-width="1.4" cx="12" cy="5.4" r="1.3"/><g class="ink" stroke-width="1"><path d="M8.8 19 V21.2 M9.8 19 V21.4 M10.8 19 V21.2 M15 16.2 L15.2 18.4 M16 16.1 L16.3 18.2 M17 16 L17.3 17.8"/></g><g class="ink" stroke-width="0.9" opacity="0.55"><path d="M9 15 H11.4 M9.3 12.2 H11.7 M14.3 12.2 L16.4 12 M14 9.6 L15.8 9.2"/></g><path class="ink" stroke-width="1.1" d="M19 9.2 L21.2 8 M19.4 11.4 L22 11.4 M19 13.6 L21.2 14.8"/></svg>`,
  ...
  // nothing typed until the clock was nearly out: a face with its cheeks puffed and eyes squeezed
  // shut, a couple of bubbles escaping. The flat line with a flick at its end read as a crack
  heldbreath:`<svg viewBox="0 0 24 24"><circle class="ink-fill" cx="11.4" cy="12.8" r="8.4"/><path class="ink" stroke-width="1.3" d="M6.8 10 L9 11 L6.8 12 M16 10 L13.8 11 L16 12"/><path class="ink" stroke-width="1.5" d="M10.1 16.3 H12.8"/><path class="ink" stroke-width="1" opacity="0.6" d="M5.2 14.4 C5.8 16.2 7.2 17 8.4 16.8 M17.6 14.4 C17 16.2 15.6 17 14.4 16.8"/><circle class="ink" stroke-width="1.1" cx="20.4" cy="4.8" r="1.3"/><circle class="ink" stroke-width="1" cx="22.2" cy="1.8" r="0.8"/></svg>`,
  // the top suggestion taken every time: a money sack, drawstring tied, dollar sign on the front,
  // because the charm's name is the picture. The list with its first row inked read as a
  // settings menu
  topofthelist:`<svg viewBox="0 0 24 24"><path class="ink-fill" d="M9.2 7.4 C5.4 10 3.6 13.6 4.2 17 C4.8 20.2 7.6 21.6 12 21.6 C16.4 21.6 19.2 20.2 19.8 17 C20.4 13.6 18.6 10 14.8 7.4 Z"/><path class="ink" stroke-width="1.4" d="M9 7.2 C10.8 6.6 13.2 6.6 15 7.2"/><path class="ink-fill" stroke-width="1.4" d="M9.6 6.6 L8.2 3.2 C9.6 3.8 10.6 3.2 12 2.6 C13.4 3.2 14.4 3.8 15.8 3.2 L14.4 6.6"/><path class="ink" stroke-width="1.6" d="M14 12.6 C13.4 11.7 10.4 11.5 10.2 13.3 C10 15 13.8 14.6 13.8 16.6 C13.8 18.4 10.8 18.2 10 17.2 M12 10.6 V19.4"/></svg>`,
  ...
  // head, one still smoking
  hintsburnt:`<svg viewBox="0 0 24 24"><g class="ink" stroke-width="1.5"><path d="M5.4 21.2 L7.1 9.6"/><path d="M11.6 21.4 V11 C11.6 9.8 12.2 9 13.1 8.8"/><path d="M17.8 21 L16.3 11.4 C16.1 10.4 16.4 9.6 17 9.2"/></g><g fill="currentColor"><ellipse cx="7.3" cy="7.9" rx="1.35" ry="1.9" transform="rotate(8 7.3 7.9)"/><ellipse cx="14.2" cy="8.2" rx="1.3" ry="1.75" transform="rotate(62 14.2 8.2)"/><ellipse cx="17.8" cy="8.2" rx="1.25" ry="1.7" transform="rotate(36 17.8 8.2)"/></g><path class="ink" stroke-width="1" opacity="0.55" d="M7.8 5.4 C6.8 4.2 8.4 3.4 7.4 2 C7 1.4 7.4 0.9 8 0.6"/><path class="ink" stroke-width="0.9" opacity="0.35" d="M2.2 21.6 H21.8"/></svg>`,
  // the caps lock key with its light on: an answer sent in capitals
  shoutcaps:`<svg viewBox="0 0 24 24"><rect class="ink-fill" x="3" y="3.4" width="18" height="17.4" rx="2.6"/><rect class="ink" stroke-width="1" x="5" y="4.8" width="14" height="12.6" rx="1.6"/><path class="ink" stroke-width="1.35" d="M12 6.8 L16.2 11.4 H13.8 V14.3 H10.2 V11.4 H7.8 Z"/><circle cx="16.4" cy="15.6" r="0.8" fill="currentColor"/><g class="ink" stroke-width="0.9" opacity="0.6"><path d="M17.9 14.3 L18.6 13.7"/><path d="M18.2 15.8 H19"/></g><path class="ink" stroke-width="0.9" opacity="0.4" d="M5.2 19.2 H18.8"/></svg>`,
  ...
  // written out as what it is: the word on its card, an equals sign, the record, and a tick
  // under the lot. Well, yes
  equals:`<svg viewBox="0 0 24 24"><rect class="ink-fill" x="1.8" y="7.8" width="7.8" height="6.4" rx="0.6" transform="rotate(-4 5.7 11)"/><path class="ink" stroke-width="1.3" d="M3.4 11.4 C4.4 10.6 5.4 11.9 6.2 11 C6.8 10.4 7.4 10.7 8 11"/><g class="ink" stroke-width="1.8"><path d="M11 9.9 H13.5"/><path d="M11.1 12.4 H13.4"/></g><circle class="ink-fill" cx="18.2" cy="11.2" r="4.3"/><circle class="ink" stroke-width="1" cx="18.2" cy="11.2" r="1.45"/><circle cx="18.2" cy="11.2" r="0.4" fill="currentColor"/><path class="ink" stroke-width="1.9" d="M8.8 18.2 L10.9 20.3 L15.2 16"/></svg>`,
  ...
  // a gramophone, the shape everyone knows as album-of-the-year gold. The record in a wreath
  // read as a medal or a beetle, and two discs side by side read as a pair of glasses
  laurel:`<svg viewBox="0 0 24 24"><path class="ink-fill" d="M9.4 12.2 C11.2 9.6 13.2 5.8 14.4 2.4 C17.6 2.8 20.8 5 22 8.2 C18.8 8.8 15.2 10.4 12.2 13"/><g class="ink" stroke-width="0.85" opacity="0.5"><path d="M11 11.1 C13.8 8.4 17.4 5.2 20.4 4.9"/><path d="M10.2 11.8 C13 7.8 15.4 4.4 16.9 2.7"/></g><path class="ink" stroke-width="1.4" d="M9.4 12.2 L10.7 13.5 C9.6 14.2 9 15 9.2 15.8"/><ellipse class="ink" stroke-width="1.2" cx="9.8" cy="15.9" rx="5.6" ry="1.1"/><rect class="ink-fill" x="3.6" y="16.4" width="12.6" height="4.8" rx="0.6"/><path class="ink" stroke-width="1.2" d="M3.6 18.4 H1.9 V16.8"/><path class="ink" stroke-width="0.9" opacity="0.5" d="M5.4 19.4 H14.4"/></svg>`,
  ...
  // the word in the very first line: stage curtains drawn open and tied back, a spot on the
  // boards. Its pair is `lastline`, the same curtains shut; the two ruled pages they replace
  // could not be told apart below full size
  firstline:`<svg viewBox="0 0 24 24"><path class="ink" stroke-width="1.5" d="M1.8 3.4 H22.2"/><path class="ink-fill" d="M2.6 3.6 H7.6 C7 8 6.2 11.4 4.2 13.2 C5.8 16 6.8 18.6 7 21.4 H2.6 Z"/><path class="ink-fill" d="M21.4 3.6 H16.2 C16.9 8.2 17.8 11.8 19.8 13.4 C18.2 16.2 17.1 18.8 16.9 21.4 H21.4 Z"/><g fill="currentColor"><circle cx="4.4" cy="13.2" r="0.9"/><circle cx="19.6" cy="13.4" r="0.9"/></g><g class="ink" stroke-width="0.9" opacity="0.5"><path d="M4.6 3.8 C4.8 7 4.4 10 3.6 12.4 M19.4 3.8 C19.2 7 19.6 10 20.4 12.8"/></g><path class="ink" stroke-width="1.2" d="M1.6 21.6 H22.4"/><ellipse class="ink" stroke-width="0.9" opacity="0.45" cx="12" cy="19.8" rx="3.6" ry="0.9"/><path class="ink" stroke-width="1.2" d="M2 3.6 q1.25 2 2.5 0 q1.3 2.1 2.5 0 q1.2 1.9 2.5 0 q1.25 2 2.5 0 q1.3 2.1 2.5 0 q1.2 1.9 2.5 0 q1.25 2 2.5 0 q1.3 2 2.5 0"/></svg>`,
  // the word in the very last line: the curtains from `firstline`, drawn shut
  lastline:`<svg viewBox="0 0 24 24"><path class="ink" stroke-width="1.5" d="M1.8 3.4 H22.2"/><path class="ink-fill" d="M2.4 3.6 H12 V21.4 H3.2 C2.8 15 2.6 9 2.4 3.6 Z"/><path class="ink-fill" d="M12 3.6 H21.6 C21.4 9.4 21.2 15.4 20.8 21.4 H12 Z"/><g class="ink" stroke-width="0.9" opacity="0.5"><path d="M5.4 4 C5.8 9 5.2 15 5.8 21 M8.6 4 C8.2 10 8.8 15 8.4 21 M15.4 4 C15.8 9 15.2 15 15.6 21 M18.4 4 C18 10 18.6 16 18.2 21"/></g><path class="ink" stroke-width="1.2" d="M1.6 21.6 H22.4"/><path class="ink" stroke-width="1.2" d="M2 3.6 q1.25 2 2.5 0 q1.3 2.1 2.5 0 q1.2 1.9 2.5 0 q1.25 2 2.5 0 q1.3 2.1 2.5 0 q1.2 1.9 2.5 0 q1.25 2 2.5 0 q1.3 2 2.5 0"/></svg>`,
  // a long pencil and a stub worn right down, points lined up: the longest title and the
  // shortest, one game
  shortlong: `<svg viewBox="0 0 24 24"><g transform="rotate(-9 12 12)"><path class="ink-fill" d="M2.4 5.8 H17.2 L21.4 7.6 L17.2 9.4 H2.4 Z"/><path class="ink" stroke-width="1" d="M4.4 5.8 V9.4 M5.4 5.8 V9.4"/><path class="ink" stroke-width="1" d="M17.2 5.8 V9.4"/><circle cx="20.6" cy="7.6" r="0.55" fill="currentColor"/><path class="ink-fill" d="M10.4 14.6 L11 15.6 L10.3 16.6 L11 17.4 L10.4 18.2 H17.2 L21.4 16.4 L17.2 14.6 Z"/><path class="ink" stroke-width="1" d="M17.2 14.6 V18.2"/><circle cx="20.6" cy="16.4" r="0.55" fill="currentColor"/></g></svg>`,
  ...
  // the word that ended one answer opening the next: two dominoes, the second laid on to match
  // the end of the first. Two tabs and an arrow read as a rubber stamp
  wordchain: `<svg viewBox="0 0 24 24"><g transform="rotate(-8 8 7.4)"><rect class="ink-fill" x="2" y="4.4" width="12" height="6" rx="1.2"/><path class="ink" stroke-width="1.1" d="M8 4.8 V10"/><g fill="currentColor"><circle cx="4.2" cy="6.2" r="0.75"/><circle cx="5.8" cy="8.6" r="0.75"/><circle cx="9.6" cy="5.8" r="0.75"/><circle cx="11" cy="7.4" r="0.75"/><circle cx="12.4" cy="9" r="0.75"/></g></g><g transform="rotate(6 16 16)"><rect class="ink-fill" x="10" y="13" width="12" height="6" rx="1.2"/><path class="ink" stroke-width="1.1" d="M16 13.4 V18.6"/><g fill="currentColor"><circle cx="11.6" cy="14.4" r="0.75"/><circle cx="13" cy="16" r="0.75"/><circle cx="14.4" cy="17.6" r="0.75"/><circle cx="19" cy="16" r="0.75"/></g></g><path class="ink" stroke-width="1.1" d="M13.8 11.4 C13.2 12.2 12.8 12.6 12.2 13"/></svg>`,
  ...
  // gold rush, taken at face value: a pickaxe and a nugget with a glint. The pan read as a bowl
  // of soup
  goldpan:`<svg viewBox="0 0 24 24"><path class="ink" stroke-width="2" d="M4.6 21.2 L15.8 7.8"/><path class="ink-fill" d="M10.2 2.9 C14 1.8 20.4 6.6 21 11.9 C18.6 8.6 14.6 5.4 10.2 2.9 Z"/><path class="ink-fill" stroke-width="1.4" d="M13.8 19.8 L15.2 17.2 L18.2 16.6 L20.6 18 L20.2 20.8 L17 21.6 Z"/><path class="ink" stroke-width="0.9" opacity="0.55" d="M15.2 17.2 L17 19 L20.6 18 M17 19 L17 21.6"/><path class="ink" stroke-width="1.1" d="M21.4 13.2 V15.4 M20.3 14.3 H22.5"/></svg>`,
  ...
  // the station plate hung on its two rods with a big 13 on it, over the tiled wall. The plate
  // lost inside the tiles before, and the whole mark read as a brick wall
  stationsign:`<svg viewBox="0 0 24 24"><path class="ink" stroke-width="1.2" d="M7 1.8 V6.2 M17.2 1.6 V6.2"/><rect class="ink-fill" x="2.4" y="6.2" width="19.2" height="9.4" rx="1.4"/><path class="ink" stroke-width="1.9" d="M7.8 9.4 L9.4 8.4 V13.4"/><path class="ink" stroke-width="1.9" d="M12.4 9 C13.4 8 15.6 8.1 15.6 9.6 C15.6 10.6 14.6 10.9 13.8 10.9 C14.8 10.9 15.9 11.3 15.9 12.3 C15.9 13.9 13.4 14.1 12.3 13.1"/><g class="ink" stroke-width="0.9" opacity="0.4"><path d="M1.6 18.4 H22.4 M1.6 21.6 H22.4 M5 18.4 V21.6 M11 18.4 V21.6 M17 18.4 V21.6"/></g></svg>`,
  // Speak Now, crashing the wedding: the three-tier cake with its topper knocked flying off the
  // top. Two bells tied on a ribbon read as a pair of kitchen scales
  weddingbells:`<svg viewBox="0 0 24 24"><rect class="ink-fill" x="3.4" y="15.4" width="17.2" height="5.8" rx="1"/><rect class="ink-fill" x="5.8" y="10.4" width="12.4" height="5" rx="0.9"/><rect class="ink-fill" x="8.4" y="6.4" width="7.2" height="4" rx="0.8"/><g class="ink" stroke-width="1" opacity="0.55"><path d="M3.6 17.2 q1.4 1.4 2.8 0 q1.4 1.4 2.8 0 q1.4 1.4 2.8 0 q1.4 1.4 2.8 0 q1.4 1.4 2.8 0 q1.4 1.4 2.8 0"/><path d="M6 12 q1.5 1.4 3 0 q1.5 1.4 3 0 q1.5 1.4 3 0 q1.5 1.4 3 0"/></g><path class="ink" stroke-width="1.3" d="M1.8 21.8 H22.2"/><path class="ink" stroke-width="1.1" d="M12.6 6.2 L16.4 3.6"/><path class="ink-fill" stroke-width="1.2" d="M17.4 4.2 C16.2 3.4 16.3 1.7 17.5 1.6 C18.1 1.6 18.4 2 18.5 2.4 C18.8 1.9 19.4 1.7 19.9 1.9 C21 2.4 20.3 3.9 17.4 4.2 Z"/><path class="ink" stroke-width="1" d="M20.8 5.8 L22.2 6.6 M20 7.4 L21.2 8.6"/></svg>`,
  ...
  // a monocle on its chain with one word under the lens: one look
  oneword: `<svg viewBox="0 0 24 24"><circle class="ink-fill" stroke-width="2" cx="10" cy="10" r="6.3"/><circle class="ink" stroke-width="0.8" opacity="0.45" cx="10" cy="10" r="4.9"/><path class="ink" stroke-width="1" opacity="0.6" d="M6.8 8 C7.3 6.6 8.5 5.7 9.8 5.5"/><path class="ink" stroke-width="2.1" d="M7.4 11.2 H12.4"/><path class="ink" stroke-width="1.5" stroke-dasharray="0.1 1.35" d="M14.7 14.3 C17.2 16.1 16.4 19 19.1 20.1 C20.3 20.5 21.3 20.1 21.9 19"/></svg>`,
  ...
  // the blank start button: lips zipped shut, pull tab hanging off the end. The quiet one,
  // wearing the button that says nothing. The bar of music with a rest in it before this
  // came out as a solid black slab at charm size
  restbar:`<svg viewBox="0 0 24 24"><path class="ink-fill" d="M2.6 12 C4.6 8.4 7.6 6.6 9.6 7.4 C10.6 7.8 11.4 8.2 12 8.2 C12.6 8.2 13.4 7.8 14.4 7.4 C16.4 6.6 19.4 8.4 21.4 12 C19.4 15.8 16 17.6 12 17.6 C8 17.6 4.6 15.8 2.6 12 Z"/><path class="ink" stroke-width="1.3" d="M3.4 12 H17.8"/><path class="ink" stroke-width="0.9" d="M5.2 11 V13 M7.2 11 V13 M9.2 11 V13 M11.2 11 V13 M13.2 11 V13 M15.2 11 V13"/><rect class="ink-fill" stroke-width="1.2" x="17.6" y="10.7" width="2.2" height="2.6" rx="0.4"/><path class="ink-fill" stroke-width="1.2" d="M18 13.3 L17.4 17.4 H20.2 L19.4 13.3"/></svg>`,
  ...
  // a firecracker with its fuse burnt down to the nub and the burnt length dotted behind it.
  // A clock was unavailable six times over (stopwatch, halfdial, lasttick, clockrush,
  // hourglass, clock), so the last hundredth is told by the fuse
  lastfuse:`<svg viewBox="0 0 24 24"><rect class="ink-fill" x="9" y="8.6" width="6" height="13.2" rx="1.1"/><g class="ink" stroke-width="0.95" opacity="0.6"><path d="M9 12.4 L15 10.4"/><path d="M9 15.8 L15 13.8"/><path d="M9 19.2 L15 17.2"/></g><path class="ink" stroke-width="1.4" d="M12 8.6 V7.3"/><path class="ink" stroke-width="1" opacity="0.4" stroke-dasharray="0.1 1.5" d="M12 7.2 C12.6 5 15 4 17 4.6 C19 5.2 19.6 3.4 21 2.4"/><g class="ink" stroke-width="1.15"><path d="M12 4.4 V2.6"/><path d="M13.8 5.1 L15 4.1"/><path d="M10.3 5 L9.1 4.2"/><path d="M14.4 6.8 H15.8"/><path d="M9.7 6.7 H8.5"/></g><circle cx="12" cy="6.2" r="0.85" fill="currentColor"/></svg>`,
  // a coffee shop loyalty card punched full, the last box stamped with a star. Ring stains read
  // as abstract squiggles and a mug from above came out a frying pan
  cuprings:`<svg viewBox="0 0 24 24"><g transform="rotate(-4 12 12)"><rect class="ink-fill" x="1.8" y="5.4" width="20.4" height="13.2" rx="1.4"/><path class="ink" stroke-width="0.9" opacity="0.45" stroke-dasharray="1 1.1" d="M11.2 6.4 V17.6"/><path class="ink-fill" stroke-width="1.4" d="M4.4 10 H8.8 V13.8 C8.8 14.9 8 15.6 7 15.6 H6.2 C5.2 15.6 4.4 14.9 4.4 13.8 Z"/><path class="ink" stroke-width="1.2" d="M8.8 10.9 C10.1 10.9 10.1 13 8.8 13"/><path class="ink" stroke-width="0.95" opacity="0.55" d="M5.8 8.8 C5.4 8.2 6.2 7.8 5.8 7.2 M7.4 8.8 C7 8.2 7.8 7.8 7.4 7.2"/><g fill="currentColor"><circle cx="13.6" cy="9.4" r="1.2"/><circle cx="16.6" cy="9.3" r="1.15"/><circle cx="19.6" cy="9.5" r="1.2"/><circle cx="13.7" cy="14.2" r="1.15"/><circle cx="16.6" cy="14.3" r="1.2"/></g><path class="ink" stroke-width="1.1" d="M19.6 12.8 L20 13.8 L21.1 13.9 L20.3 14.6 L20.5 15.7 L19.6 15.1 L18.7 15.7 L18.9 14.6 L18.1 13.9 L19.2 13.8 Z"/></g></svg>`,
  ...
  // an ink bottle knocked on its side, the ink running out across the desk: the one charm in
  // the game where too much ink is the feat. A blot soaking through a ruled page was drawn
  // first and read as an eye, the hazard of a dark centre inside a round outline
  inkwell:`<svg viewBox="0 0 24 24"><g transform="translate(8.6 11.4) rotate(100)"><path class="ink-fill" d="M-4.4 5 V-1.2 C-4.4 -2.6 -3.2 -3.4 -1.8 -3.6 V-5 H1.8 V-3.6 C3.2 -3.4 4.4 -2.6 4.4 -1.2 V5 C4.4 5.6 4 6 3.4 6 H-3.4 C-4 6 -4.4 5.6 -4.4 5 Z"/><rect class="ink-fill" stroke-width="1.3" x="-2.4" y="-6.3" width="4.8" height="1.4" rx="0.4"/></g><path d="M15.4 11.6 C17.4 11.8 18.6 13 18.8 14.6 C21 15 22.4 16.4 21.6 18 C20.6 19.8 15 20 11.6 19.6 C9.8 19.4 9.6 18.4 11 18 C13.4 17.4 15.6 16.8 16.2 15.2 C16.6 14 16.2 13 15.4 12.8 Z" fill="currentColor"/><path d="M20.4 7.6 C21.2 8.6 21.3 9.5 20.4 9.5 C19.5 9.5 19.6 8.6 20.4 7.6 Z" fill="currentColor"/><path class="ink" stroke-width="0.9" opacity="0.4" d="M1.8 17.4 H8.6"/></svg>`,
  ...
  // an endless run over on its very first page: a banana peel, the pratfall drawn as the thing
  // you slipped on. The record with a needle skid read as a no-entry sign, which `nosign` is
  skid:`<svg viewBox="0 0 24 24"><path class="ink" stroke-width="1.8" d="M12.6 2.4 L12.2 4.6"/><path class="ink-fill" d="M9.6 9.6 C9.4 6.8 10.4 4.6 12.2 4.6 C14 4.6 14.8 6.8 14.6 9.6 Z"/><path class="ink-fill" d="M9.6 9.6 C7 10.4 4.6 12.8 3 16.4 C2.4 17.8 3.2 18.6 4.4 18 L5.2 17.6 C6.6 15.4 8.6 13.8 11 13.2 Z"/><path class="ink-fill" d="M14.6 9.6 C17.2 10.2 19.6 12.4 21.2 15.8 C21.8 17.2 21 18 19.8 17.4 L19 16.9 C17.6 14.8 15.6 13.4 13.2 13 Z"/><path class="ink-fill" d="M10.4 11.6 C9.8 14.8 10.2 18 11 20.6 C11.4 21.8 12.8 21.8 13.2 20.6 C14 18 14.4 14.8 13.8 11.6 Z"/><g class="ink" stroke-width="0.8" opacity="0.5"><path d="M8.2 12 C6.6 13.4 5.4 15 4.6 16.6 M16 12 C17.6 13.2 18.8 14.8 19.6 16.2 M12.1 13.4 V19.6"/></g><path class="ink" stroke-width="1.1" opacity="0.6" d="M15.4 21.8 C17.6 21 20 21 22.4 21.6"/></svg>`,
  ...
  // a song she wrote alone: a pen pot with one pencil standing in it. The credits card with one
  // line filled was another ruled box among a dozen
  oneline:`<svg viewBox="0 0 24 24"><path class="ink-fill" d="M6 11 H18 L17 21.4 H7 Z"/><path class="ink" stroke-width="1.2" d="M5.4 11 H18.6"/><path class="ink" stroke-width="0.9" opacity="0.4" d="M6.8 14.4 H17.2"/><path class="ink-fill" stroke-width="1.4" d="M10.6 11 L14.4 3.8 L16.2 4.8 L12.6 11"/><path class="ink" stroke-width="1.2" d="M14.4 3.8 L16.5 1.8 L16.2 4.8"/></svg>`,
  // a Nashville run with no wrong calls: a cowboy hat with a tick on the crown. Two columns of
  // ticks, one left empty, read as a spreadsheet
  emptycross:`<svg viewBox="0 0 24 24"><path class="ink-fill" d="M1.8 13.8 C3.4 16.6 7.4 17.8 12 17.8 C16.6 17.8 20.6 16.6 22.2 13.8 C20.4 14.8 17.8 15.2 16.8 15 H7.2 C6.2 15.2 3.6 14.8 1.8 13.8 Z"/><path class="ink-fill" d="M7 15 C6.6 11.4 6.6 7.6 7.8 6 C8.8 4.8 10.4 6.2 12 5.6 C13.6 6.2 15.2 4.8 16.2 6 C17.4 7.6 17.4 11.4 17 15 Z"/><path class="ink" stroke-width="1" opacity="0.5" d="M12 5.8 V7.4"/><path class="ink" stroke-width="1.1" d="M7 12.6 C10.4 13.2 13.6 13.2 17 12.6"/><path class="ink" stroke-width="1.6" d="M9.8 9.4 L11.4 10.8 L14.4 7.6"/></svg>`,
...
export const ACHIEVEMENTS = [
  ...
  { id: "score-zero",        name: "I'm The Problem",  desc: "Score 0/13",                          secret: true,  icon: "votepin" },
...
// Margin doodles: little inked sketches down the outer margin, each a quiet nod to
// Swift lore.
//
// PORTRAIT, AND FEW STROKES. Both halves of that are load-bearing and neither is a
// style preference. The doodle hangs in the gutter beside the red rule (see .doodle in
// styles.css), which is about 44px wide and as tall as the page, so a drawing that needs
// width has nowhere to go: every one of these is built to read at roughly 40px across.
// And at 40px, interior texture is not detail, it is grain — the same failure the sticker
// sheet documents at its own 64px floor. A knit stitch, a fret, a whisker: none of them
// survive, they just make the mark grey. So each drawing is ONE object, silhouette first,
// and nothing inside it that a pen would not bother with in a margin.
//
// This roster is deliberately short. Four earlier drawings (a sleeping cat, an acoustic
...
export const DOODLE_SVG = {
  ...
  // five stars in a column, for the tumblr post "Stars do u like dem" (the source file is
  // doodles/stars-do-u-like-dem.svg). The one exception to portrait-and-few-strokes: the
  // drawing is a row, so it is turned on its side rather than re-laid, which keeps every star
  // where it was drawn. The marks are outlined brush strokes, so they are FILLED in ink rather
  // than stroked, and the source's three colours go the way of every other colour on the page.
  // Turning up in the margin is what finds the post.
  stars: `<svg viewBox="0 0 344 1904"><g class="ink-fill" transform="translate(344 0) rotate(90)"><path d="M776.1 60 747.6 41.9 791.2 72.9c1.8 1.9 4.8 2.7 5.1 3 3.6 4 6.9 17 6.7 22.3-.1 3.6-3.8 10.4-2.1 13.3 4.7 2.7 9.4 6 14.3 8.3 38.1 17.4 57.2 6.9 86.3-19 6-5.4 16.8-15.3 22-21.1 6.7-7.4 28-42.8 35.6-44.3 6-1.1 12.1 1.9 12.1 8.5-6.2 21.5-7.1 43-6.3 65.2l70.4 1.1c7.6-.9 5.2-3.4 9.2-6.3 22.8-16.7 55.8-27.1 83.8-19 17.5 5 31.3 29.1 13.7 41.4-13.4 9.3-27.6 5.5-43 6.1-5 .2-12.2 2.6-16.9 2.6-9.9 0-22.7-5-32.4-5.3-12.1-.3-19.9 14.6-26.5 22.6-2.6 3.2-7 6.9-9.5 10-2.6-.1-3.4 1-3.4 3.6-.8.8-.5.4-1.3 2.3-3.8-.2.7-10.5 5.5-6.8-.4.2-12.2 15.7-13 16.3-.8.7-5.2 10.8-6 12.8-4.6 11.8-11.8 31.2-12.4 42.6-.1 1.7-.9 3.8-1.1 5.5-3.3 5.2-2.7 6.3-2.8 8.1-1 13.4-.7 32.3 0 45.9.3 5.3.7 12.2 1.4 17.4.6 4.5 3.7 4.3 1.5 10.7-2.9 8.6-11.3 10.7-17.8 4.3.4-4.4-
.2-11.2 4.1-18.1 1.3-1-3-4.2-5.6-2.6-10.3 3.3.6 3-3 5.2-4.5 8-5.8 12.2-5.3 20.7-14.3 3-3.2 13.8-15 11.1-18.8-1.3-1.3-2.9-1.4-4.6-1.2 1.4-6.6-2.5-5.2-5-7.2-1.2-1-1.6-2.7-2.9-3.7s-3.6-.6-3.8-.7c-.4-.4-.2-10 .6-11.7 1-2.1 6.7-4.2 7.1-5.2 3.9 3.4 10.2 7.9 15.5 7.8 0 2.8 1 11.7 5.9 7.8l48.2-72.2c12.2-19.6 25.3-9.8 25 10.7-.3 17.4-7.5 26.1-14.3 40.7ZM211.6 86.4c-.1-.1-3.7-.5-4 .8l-36.1 57.4c1.4 1.4 6.7-4.7 7.8-5.8 4.6-4.5 13.7-15.1 17.3-20.2 2.2-3.2 16.5-30.8 15-32.2ZM162 178.5c-9.2 3.1-18.2 9-17.6 19.9.2 3.2 4.4 6.6 7.6 5.1 1.2-.6 13.1-11.2 13.6-12.4 1.5-3.6 1.6-12.8-3.6-12.7Z"/><path d="M1338.5 186c.6.6 13.6 4.3 14.2 9.1-1.8 2-.7 3.5-7 8-2.6 1.9-1.5 4.9-7.3 3.7-2.2-.5-7.1-4.3-10-4.9-20.2-4.2-19.1 11.2-24.9 25.6-9.9 3-9.8 1.1-18.1 1.3.9-9.7 4.5-18.7 9.1-27.2 3.4-6.4 21.1-16.5 28.5-18.1 1.3-.3 3.4.3 5 .3 2.1.5 3.1.9 5.4 1.2 1.7.2 3.5.9 5.2 1.1"/><path d="M480.7 82.5c.8.6 5.3-1.2 7.1-1.3 4.3-.2 11.6-.6 15.6-.1 2.1.3 1.7 1.3 2.6 2.7.2.3 1.7-.2 1.8 0 .2.4-.3 3.8.3 5.5 1.4 4.2 21 20 25.6 21.1 2.2.5 11.7-.7 14.3-1.3 4.3-1 8.4-4.4 11.6-4.6 4.6-.3 10.6 4.9 14.2 7.8-.4.3-1.8 4.2-4.5 6.5-10.8 9-31.3 12.7-44.6 8.3-4.1-1.4-14.6-10.3-18.8-13.6-3.2-2.5-5-7.2-9.7-6.4l-6.5 47.9c-3 .2-4.9 2.8-7.8-.6-4.7-5.6-8-18.1-7.7-25.3.6-15.6 8.6-30.6 6.5-46.6Z"/><path d="M566.1 220.9c1.1 4.3-4.9 2.2-8.1 2.9-11.1 2.4-26.2 4.6-37.8 4.9-7 .2-23.4-.2-29.8-1.4-2.8-.5-4.1-2.7-5.8-4.5l2.2-2.9 29.5-6.9 49.8 7.9Z"/><path d="M601 126.5c.2 1.2-.1 2.6 0 3.9-5.3 1-13.1 2.4-18.1 3.9-.9-6.6 2-12.9 1.3-19.4 2.7-1.2 3.2-1.1 5.8-.1.9.4 6.7 3.1 7.1 3.4 1.8 1.2 3.5 6.1 3.9 8.3Z"/><path d="M456.1 191.2c8.5-1.1 8.7 5.8 1.1 8.2-10.7 3.4-7-1.5-8.8-5.6 3 .5 5-2.2 7.8-2.6Z"/></g></svg>`,
...
export const DOODLE_SIZE = {
  ...
  stars: [32, 176],   // under the others: any taller and the column meets the page register on a short page
};
