...
The approved `boots.svg` is the user-edited Illustrator export. Its lettering placement is authoritative. The local generator preserves that file and only regenerates the guitar and pegacorn.
