...
export const STICKERS = [
  ...
  <g transform="rotate(-4.6 50 50)">
    ...
    <g fill="#3a2758">
      <rect x="17.2" y="31.4" width="20.4" height="5" rx="2.1"/>
      <rect x="39.9" y="31.6" width="4.7" height="4.8" rx="2"/>
      <rect x="47" y="31.4" width="23.8" height="5" rx="2.1"/>
    </g>
    <path class="ln t" fill="none" stroke="#7e62b4" opacity="0.85" d="M17.1 41.3 C36 40.6 63 40.5 82.2 41"/>
    <path class="ln t" fill="#f7f2e4" stroke="#4a3268" d="M16.9 45.9 L43.4 45.6 L43.8 70.4 L17.2 70.7 Z"/>
    <g class="ln t" stroke="#4a3268" fill="#9a7ac8">
      <path d="M30.2 58 C26.7 51.2 20.2 48.9 19.1 53.4 C18.1 57.6 22.9 60.3 30.2 58 Z"/>
      <path d="M30.2 58 C33.9 51.3 40.3 49.1 41.3 53.6 C42.2 57.8 37.4 60.3 30.2 58 Z"/>
      <path d="M30.2 58.3 C27 63.9 22.4 67 21.4 63.6 C20.5 60.4 24.5 58 30.2 58.3 Z"/>
      <path d="M30.2 58.3 C33.5 64 38.1 66.9 39 63.5 C39.8 60.3 35.8 58 30.2 58.3 Z"/>
    </g>
    <path class="ln t" fill="none" stroke="#3a2758" d="M30.1 51.5 C30.3 57.4 30.4 62.4 30.3 66.2"/>
    <g fill="#5c4a7a">
      <rect x="49.2" y="47.8" width="33.4" height="3.5" rx="1.75"/>
      <rect x="49.2" y="55.1" width="26.1" height="3.5" rx="1.75"/>
      <rect x="49.2" y="62.4" width="30.2" height="3.5" rx="1.75"/>
    </g>
    <g fill="#5c4a7a" opacity="0.6">
      <circle cx="50.6" cy="70.2" r="1.7"/><circle cx="57.1" cy="70.4" r="1.6"/><circle cx="63.4" cy="70.2" r="1.7"/>
    </g>
  </g>
</svg>`,
  },
  {
    ...
    era: "The guest shelf",
    art: `<svg class="stick" viewBox="0 0 100 100">
  <path class="ln" fill="#26221f" d="M30.4 63.6 C31.2 51.6 35.3 39 41.6 28.8 C46.4 20.9 52.7 13 60.5 10.2 C67.9 7.6 72.2 12.3 68.9 18.3 C66.4 22.8 61.1 25.5 58.6 30.3 C54.9 37.6 60.5 50.7 71.1 63.6 Z"/>
  <path class="ln t" fill="none" stroke="#5f564e" opacity="0.6" d="M50.6 22.4 C46.8 30.2 43.6 39.4 41.4 48.6"/>
  <path class="ln" fill="#1d1a18" d="M11.4 67.4 C11.3 61.1 28.5 55.9 50.4 55.9 C72.3 55.9 88.9 61.3 88.5 68.2 C88.1 75.1 71.3 80.6 49.4 80.3 C27.5 80 11.5 74.1 11.4 67.4 Z"/>
  <path class="ln t" fill="none" stroke="#5f564e" opacity="0.5" d="M20.9 65.4 C30.6 70.7 45.9 72.8 58.9 71.2"/>
  <path class="ln t" fill="#d08fa2" stroke="#8f4f63" d="M33.4 42.9 C40.9 39.9 53.6 39.7 59.7 42.5 L63.9 55.1 C55.8 51.4 39.4 51.9 31.2 55.6 Z"/>
  <g class="ln t" stroke="#8f4f63">
    <path fill="#c67e93" d="M61.6 43.6 C70.6 36.4 82.5 38.9 82.1 46 C81.7 52.4 72.5 54.1 64.6 50.1 Z"/>
    <path fill="#c67e93" d="M64.2 51.4 C72.9 54.4 79.4 61.6 76 66.2 C72.8 70.5 66.3 65.1 62.4 56.8 Z"/>
    <path fill="#d08fa2" d="M63.4 55.6 C68.1 63.9 70.2 72.2 69.2 79.6 C67.3 78.4 65.7 76.6 64.3 74.2 C62.4 76.9 60.4 78.7 58.2 79.6 C57.9 71.8 59.1 63.7 61.4 56.4 Z"/>
    <path fill="#e0a8b8" d="M59.6 44.4 C64.8 42.3 68.9 47.7 66.2 52.7 C63 58.1 56.4 54.4 57.3 48.4 Z"/>
  </g>
</svg>`,
  },
  {
    ...
    era: "The guest shelf",
    art: `<svg class="stick" viewBox="0 0 100 100">
  <path class="ln" fill="#e8c877" d="M50 12.2 C31.9 12.2 21.9 24.6 21.6 41.6 L21.9 78.4 C21.9 81.9 24.6 83.4 27.6 82.9 C30.9 82.4 32.9 80.4 33.1 77.1 L33.4 45.4 C39.9 48.4 60.1 48.4 66.6 45.4 L66.9 77.1 C67.1 80.4 69.1 82.4 72.4 82.9 C75.4 83.4 78.1 81.9 78.1 78.4 L78.4 41.6 C78.1 24.6 68.1 12.2 50 12.2 Z"/>
  <g class="ln t" fill="none" stroke="#b8913e" opacity="0.85">
    <path d="M33.6 19.6 C31.4 27.9 30.6 36.9 31 45.4"/>
    <path d="M41.4 15.4 C39.6 25.6 39 36.1 39.4 46.9"/>
    <path d="M50.2 14 C49.4 25.1 49.2 36.4 49.6 47.6"/>
    <path d="M58.6 15.6 C60.4 25.9 61 36.4 60.4 46.9"/>
    <path d="M66.6 19.9 C68.9 28.1 69.6 36.9 69.1 45.4"/>
    <path d="M25.9 47.4 C24.9 58.6 24.9 69.6 25.6 78.1"/>
    <path d="M29.6 45.4 C28.9 57.4 28.9 69.1 29.4 77.4"/>
    <path d="M74.1 47.4 C75.1 58.6 75.1 69.6 74.4 78.1"/>
    <path d="M70.4 45.4 C71.1 57.4 71.1 69.1 70.6 77.4"/>
  </g>
</svg>`,
  },
  {
    ...
    era: "The guest shelf",
    art: `<svg class="stick" viewBox="0 0 100 100">
  <path class="ln" fill="#232120" d="M19.9 43.4 C20.4 35.9 21.9 29.1 25.6 23.1 C31.1 13.4 39.6 9.6 50 9.6 C60.4 9.6 68.9 13.4 74.4 23.1 C78.1 29.1 79.6 35.9 80.1 43.4 C80.6 48.9 82.4 53.9 80.9 59.4 C79.4 64.9 82.4 70.4 81.4 76.1 C80.4 81.9 75.9 84.9 71.9 81.9 C67.4 78.4 64.6 70.4 63.4 61.9 C62.1 53.4 61.1 46.4 60.6 42.1 C57.4 39.9 53.9 38.9 50 38.9 C46.1 38.9 42.6 39.9 39.4 42.1 C38.9 46.4 37.9 53.4 36.6 61.9 C35.4 70.4 32.6 78.4 28.1 81.9 C24.1 84.9 19.6 81.9 18.6 76.1 C17.6 70.4 20.6 64.9 19.1 59.4 C17.6 53.9 19.4 48.9 19.9 43.4 Z"/>
  <path class="ln t" fill="#a8c93a" stroke="#6f8d2c" d="M21.4 33.9 C22.9 27.4 24.4 24.1 26.9 20.9 C32.4 13.1 40.1 9.6 50 9.6 C59.9 9.6 67.6 13.1 73.1 20.9 C75.6 24.1 77.1 27.4 78.6 33.9 C74.9 28.6 70.4 25.4 65.4 26.9 C61.6 28.1 58.6 24.4 54.4 23.6 C52.1 23.1 51.1 25.9 50 25.9 C48.9 25.9 47.9 23.1 45.6 23.6 C41.4 24.4 38.4 28.1 34.6 26.9 C29.6 25.4 25.1 28.6 21.4 33.9 Z"/>
  <g class="ln t" fill="none" stroke="#57534e">
    <path d="M25.4 46.9 C23.9 55.6 26.4 64.4 24.6 74.9"/>
    <path d="M31.9 48.4 C31.1 57.1 31.9 67.1 30.4 76.4"/>
    <path d="M74.6 47.4 C76.1 55.9 73.6 64.6 75.4 74.4"/>
    <path d="M68.1 49.4 C68.9 57.6 68.1 67.1 69.6 76.1"/>
    <path d="M38.6 47.9 C37.9 55.4 36.9 63.4 35.4 71.4"/>
    <path d="M61.4 47.9 C62.1 55.4 63.1 63.4 64.6 71.4"/>
  </g>
</svg>`,
  },
];
