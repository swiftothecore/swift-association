...
export const ACHIEVEMENTS = [
  ...
  { id: "blank-space",       name: "Blank Space",       desc: "Win Vanishing Word writing blind — every answer landed after the word had gone", secret: true, icon: "placeholder" },
  { id: "you-belong-with-me", name: "You Belong With Me", desc: "Win Deep Cut loyal to one album — every correct answer of the run off the same record", secret: true, icon: "placeholder" },
  { id: "tied-together",     name: "Tied Together With A Smile", desc: "Win From A to Z on a chain that climbs every link — never twice on the same letter", secret: true, icon: "placeholder" },
