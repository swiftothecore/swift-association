...
- The lineup, reached by the all-access pass at the front of that shelf: thirteen pages dealt from every catalogue at once, played under a hand of goal cards you are dealt and commit to before page one, and every bead on the bracelet is coloured by whoever you answered
...
This covers my code only. The lyrics and liner-note messages in `data/songs.json`, `data/guests/` and `data/secret-messages.json` belong to their respective writers and publishers. They are not mine, and nothing above grants any rights to them. The fonts, sound effects and the one borrowed icon carry their own licences, which are set out in [NOTICE.md](NOTICE.md).
